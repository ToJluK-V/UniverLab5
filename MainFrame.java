...
public class MainFrame extends JFrame //обеспечивает задание интерфейса пользователя, а
//также задание реакций на его действия
{
    ...
    }//инициализация и показ окна приложения
